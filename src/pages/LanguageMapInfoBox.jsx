  ...
  render() {
    ...
    return (
      <div className="LanguageMapInfoBox-container">
        <div className="LanguageMapInfoBox-title">{info.lang}</div>
        <hr/>
        <div className="LanguageMapInfoBox-location"><span className="LanguageMapInfoBox-icon" ><FontAwesomeIcon icon="globe"/></span>???</div>
        <div className="LanguageMapInfoBox-users"><span className="LanguageMapInfoBox-icon" ><FontAwesomeIcon icon="users"/></span>{info.num_speakers}<br/></div>
